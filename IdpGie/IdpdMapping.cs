...
namespace IdpGie {
    ...
    public static class IdpdMapping {
        ...
        public static void Node (DrawTheory dt, IFunctionInstance name, string graph) {

        }

        [IdpdDrawMethod("text",true,true,TermType.String)]
        public static void Text (DrawTheory dt, IFunctionInstance name, string text) {
        ...
        public static void Image (DrawTheory dt, IFunctionInstance name, double width, double height, string filepath) {

        }

        [IdpdDrawMethod("xpos",true,true,TermType.Float)]
        public static void Xpos (DrawTheory dt, IFunctionInstance name, double xpos) {

        }

        [IdpdDrawMethod("ypos",true,true,TermType.Float)]
        public static void Ypos (DrawTheory dt, IFunctionInstance name, double ypos) {

        }

        [IdpdDrawMethod("zpos",true,true,TermType.Float)]
        public static void Zpos (DrawTheory dt, IFunctionInstance name, double zpos) {

        }

        [IdpdDrawMethod("pos",true,true,TermType.Float,TermType.Float,TermType.Float)]
        public static void Pos (DrawTheory dt, IFunctionInstance name, double xpos, double ypos, double zpos) {
            Xpos (dt, name, xpos);
            Ypos (dt, name, ypos);
            Zpos (dt, name, zpos);
        }
        ...
        public static void Xshift (DrawTheory dt, IFunctionInstance name, double xpos) {

        }

        [IdpdDrawMethod("yshift",true,true,TermType.Float)]
        public static void Yshift (DrawTheory dt, IFunctionInstance name, double ypos) {

        }

        [IdpdDrawMethod("zshift",true,true,TermType.Float)]
        public static void Zshift (DrawTheory dt, IFunctionInstance name, double zpos) {

        }

        [IdpdDrawMethod("shift",true,true,TermType.Float,TermType.Float,TermType.Float)]
        public static void Shift (DrawTheory dt, IFunctionInstance name, double xpos, double ypos, double zpos) {
            Xshift (dt, name, xpos);
            Yshift (dt, name, ypos);
            Zshift (dt, name, zpos);
        }
        ...
        public static void Xscale (DrawTheory dt, IFunctionInstance name, double xscale) {

        }

        [IdpdDrawMethod("yscale",true,true,TermType.Float)]
        public static void Yscale (DrawTheory dt, IFunctionInstance name, double yscale) {

        }

        [IdpdDrawMethod("zscale",true,true,TermType.Float)]
        public static void Zscale (DrawTheory dt, IFunctionInstance name, double zscale) {

        }

        [IdpdDrawMethod("scale",true,true,TermType.Float,TermType.Float,TermType.Float)]
        public static void Scale (DrawTheory dt, IFunctionInstance name, double xscale, double yscale, double zscale) {
        ...
        public static void Rotate (DrawTheory dt, IFunctionInstance name, double ex, double ey, double ez, double alpha) {
        }

        [IdpdDrawMethod("rotateX",true,true,TermType.Float)]
        public static void RotateX (DrawTheory dt, IFunctionInstance name, double alpha) {
        }

        [IdpdDrawMethod("rotateY",true,true,TermType.Float)]
        public static void RotateY (DrawTheory dt, IFunctionInstance name, double alpha) {
        }

        [IdpdDrawMethod("rotateZ",true,true,TermType.Float)]
        public static void RotateZ (DrawTheory dt, IFunctionInstance name, double alpha) {
        }

        [IdpdDrawMethod("edgecolor",true,true,TermType.Int,TermType.Int,TermType.Int)]
        public static void EdgeColor (DrawTheory dt, IFunctionInstance name, double r, double g, double b) {

        }

        [IdpdDrawMethod("innercolor",true,true,TermType.Int,TermType.Int,TermType.Int)]
        public static void InnerColor (DrawTheory dt, IFunctionInstance name, double r, double g, double b) {

        }

        [IdpdDrawMethod("depth",true,true,TermType.Float)]
        public static void Depth (DrawTheory dt, IFunctionInstance name, double index) {
        }

        [IdpdDrawMethod("show",true,true)]
        public static void Show (DrawTheory dt, IFunctionInstance name) {

        }

        [IdpdDrawMethod("hide",true,true)]
        public static void Hide (DrawTheory dt, IFunctionInstance name) {
